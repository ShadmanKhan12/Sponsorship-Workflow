...
public class SponsorshipWorkflowDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public SponsorshipWorkflowDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
