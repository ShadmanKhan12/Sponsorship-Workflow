...
public class SponsorshipWorkflowDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        SponsorshipWorkflowGlobalFeatureConfigurator.Configure();
        SponsorshipWorkflowModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<SponsorshipWorkflowDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<SponsorshipWorkflowResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/SponsorshipWorkflow");

            options.DefaultResourceType = typeof(SponsorshipWorkflowResource);
        ...
        {
            options.MapCodeNamespace("SponsorshipWorkflow", typeof(SponsorshipWorkflowResource));
        });
    }
}
