...
{
    [DbContext(typeof(SponsorshipWorkflowDbContext))]
    partial class SponsorshipWorkflowDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SponsorshipWorkflow.Entities.SponsorshipRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSponsorshipRequests", (string)null);
                });

            modelBuilder.Entity("SponsorshipWorkflow.Entities.SponsorshipType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSponsorshipTypes", (string)null);
                });

            modelBuilder.Entity("SponsorshipWorkflow.Entities.WorkflowHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppWorkflowHistories", (string)null);
                });
            ...
            modelBuilder.Entity("SponsorshipWorkflow.Entities.SponsorshipRequest", b =>
                {
                    b.HasOne("SponsorshipWorkflow.Entities.SponsorshipType", "SponsorshipType")
                        .WithMany()
            ...
            modelBuilder.Entity("SponsorshipWorkflow.Entities.WorkflowHistory", b =>
                {
                    b.HasOne("SponsorshipWorkflow.Entities.SponsorshipRequest", "SponsorshipRequest")
                        .WithMany()
